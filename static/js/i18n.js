...
const I18N = {
  zh: {
    ...
    unique_users: "注册用户数",
    today_views: "今日访问",
    page_breakdown: "页面访问分布",
    daily_trend: "近期访问趋势",
    page_home: "主页",
    page_timetable: "课表生成器",
    page_clubs: "社团介绍",
    page_other: "其他",
    guest_label: "游客",
  ...
  en: {
    ...
    guest_views: "Guest Views",
    user_views: "Registered User Views",
    unique_visitors: "Unique Visitors",
    unique_users: "Registered Users",
    today_views: "Today's Views",
    page_breakdown: "Views by Page",
    daily_trend: "Recent Visit Trend",
    page_home: "Home",
    ...
    analytics_empty: "No visit data yet",
  }
};
